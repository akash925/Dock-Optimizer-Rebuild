...
import { db, pool, safeQuery } from "./db.js.js.js";
import { scrypt, randomBytes, timingSafeEqual } from "crypto";
import { promisify } from "util";
import { getRedis } from './src/utils/redis.js';
import { logger } from "./utils/logger.js.js.js";
import { emailService } from './services/email.js.js';
...
export class MemStorage {
  ...
  async createSchedule(insertSchedule: InsertSchedule): Promise<Schedule> {
    ...
    try {
      ...
      eventSystem.emit('appointment:created', {
        schedule: { ...schedule, lastModifiedBy: schedule.createdBy } as any,
  ...
  async getDailyAvailabilityByAppointmentType(appointmentTypeId: number): Promise<DailyAvailability[]> { return Array.from(this.dailyAvailability.values()).filter(a => (a as any).appointmentTypeId === appointmentTypeId); }
  ...
  async getCustomQuestionsByAppointmentType(appointmentTypeId: number): Promise<CustomQuestion[]> { return Array.from(this.customQuestions.values()).filter(q => (q as any).appointmentTypeId === appointmentTypeId); }
  ...
  async createAsset(insertAsset: InsertAsset): Promise<Asset> {
    ...
    const asset: Asset = { ...insertAsset, id, createdAt: new Date(), description: insertAsset.description ?? null, fileType: insertAsset.fileType ?? null, fileSize: insertAsset.fileSize ?? null, tags: insertAsset.tags ?? null, lastAccessedAt: insertAsset.lastAccessedAt ?? null } as any;
  ...
  async createCompanyAsset(companyAsset: InsertCompanyAsset): Promise<CompanyAsset> {
    ...
    const newCompanyAsset: CompanyAsset = { ...companyAsset, id, createdAt: new Date(), updatedAt: new Date(), department: (companyAsset as any).department ?? null, barcode: (companyAsset as any).barcode ?? null, serialNumber: (companyAsset as any).serialNumber ?? null, description: (companyAsset as any).description ?? null, purchasePrice: (companyAsset as any).purchasePrice ?? null, purchaseDate: (companyAsset as any).purchaseDate ?? null, warrantyExpiration: (companyAsset as any).warrantyExpiration ?? null, depreciation: (companyAsset as any).depreciation ?? null, assetValue: (companyAsset as any).assetValue ?? null, template: (companyAsset as any).template ?? null, tags: (companyAsset as any).tags ?? null, model: (companyAsset as any).model ?? null, assetCondition: (companyAsset as any).assetCondition ?? null, notes: (companyAsset as any).notes ?? null, manufacturerPartNumber: (companyAsset as any).manufacturerPartNumber ?? null, supplierName: (companyAsset as any).supplierName ?? null, poNumber: (companyAsset as any).poNumber ?? null, vendorInformation: (companyAsset as any).vendorInformation ?? null, photoUrl: (companyAsset as any).photoUrl ?? null, documentUrls: (companyAsset as any).documentUrls ?? null, lastMaintenanceDate: (companyAsset as any).lastMaintenanceDate ?? null, nextMaintenanceDate: (companyAsset as any).nextMaintenanceDate ?? null, maintenanceSchedule: (companyAsset as any).maintenanceSchedule ?? null, maintenanceContact: (companyAsset as any).maintenanceContact ?? null, maintenanceNotes: (companyAsset as any).maintenanceNotes ?? null, implementationDate: (companyAsset as any).implementationDate ?? null, expectedLifetime: (companyAsset as any).expectedLifetime ?? null, certificationDate: (companyAsset as any).certificationDate ?? null, certificationExpiry: (companyAsset as any).certificationExpiry ?? null, createdBy: (companyAsset as any).createdBy ?? null, updatedBy: (companyAsset as any).updatedBy ?? null, status: (companyAsset as any).status ?? 'ACTIVE' } as any;
  ...
  async addUserToOrganization(orgUser: InsertOrganizationUser): Promise<OrganizationUser> {
    ...
    const newOrgUser: OrganizationUser = { ...orgUser, id, createdAt: new Date() } as any;
