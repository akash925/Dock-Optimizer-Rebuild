...
// We'll implement booking pages routes directly in this file
...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  // Create and register the booking pages routes directly instead of using the router
  ...
  app.delete("/api/booking-pages/:id", async (req, res) => {
    try {
      const id = Number(req.params.id);
