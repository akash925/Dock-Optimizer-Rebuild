    ...
    return (
      <Form {...truckInfoForm}>
        <form 
          ...
          className="space-y-4"
        >
    // This is crucial to fix the FormContext null error
    return (
      <Form {...truckInfoForm}>
        <form onSubmit={truckInfoForm.handleSubmit(onTruckInfoSubmit)} className="space-y-4">
          ...
          {step === 1 && (
            <div className="space-y-4">
              {/* STEP 1: Location and Appointment Type Selection */}
              {mode === "internal" && (
                <>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) => {
                        // Fetch the appointment type details when selected
                        const typeId = parseInt(value);
                        // Set the value and force a refresh to load the type details
