            ...
            <div className="grid gap-4">
              ...
              <div className="bg-blue-50 p-4 rounded-lg border-l-4 border-blue-500 mb-4">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h3 className="font-semibold text-lg text-blue-800">Facility Details</h3>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex flex-col">
                    <span className="text-sm font-medium text-blue-700">Location</span>
                    <span className="text-lg font-semibold">{bookingDetails.location}</span>
                  </div>
                  <div className="flex flex-col">
                    <span className="text-sm font-medium text-blue-700">Appointment Date</span>
                    <span className="text-lg font-semibold">{bookingDetails.appointmentDate}</span>
                  </div>
                </div>
              </div>
