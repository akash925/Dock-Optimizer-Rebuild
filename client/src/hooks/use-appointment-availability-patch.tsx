...
/**
 * Patched version of useAppointmentAvailability hook that safely handles availabilities 
 * without causing circular reference errors with JSON.stringify
 */
export function useAppointmentAvailability({
  ...
  // Function to fetch availability for a specific date - called by appointment forms
